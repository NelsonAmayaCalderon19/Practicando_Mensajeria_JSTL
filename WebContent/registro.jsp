...
<body>
    ...
    <span class="fa fa-user input-group-text" id="basic-addon1"></span>
                              ...
                              <input type="text" name="usuario"  class="form-control" id="usuario"  placeholder="Enter Usuario" autofocus="" required="">
                           </div>
    ...
    <span class="fa fa-lock input-group-text" id="basic-addon1"></span>
                           ...
                           <div id="register-link" class="text-right">
                                <a href="index.jsp" class="text-info"><strong>Volver al Login</strong></a>
                            </div>
                           <br>
                           <div class="col-md-12 text-center ">
                              <input type="submit" name="accion" value="REGISTRARSE" class=" btn btn-block mybtn btn-primary tx-tfm">
                           </div>
